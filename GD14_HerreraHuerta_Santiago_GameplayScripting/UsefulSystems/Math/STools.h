...
namespace Pillar {
	...
	public:
		...
		static const FVector2i CalculateLerpPoint(const FVector2i& start, const FVector2i& end, const double percentageFromZeroToOne);
		static const FVector2d CalculateLerpPoint(const FVector2d& start, const FVector2d& end, const double percentageFromZeroToOne);
		static const FVector2f CalculateLerpPoint(const FVector2f& start, const FVector2f& end, const double percentageFromZeroToOne);
